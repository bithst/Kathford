...
string MonoalphabeticCipher(string, string, bool);

int main() {
    string message = "Hello world. This is a test 123.";
...
string MonoalphabeticCipher(string message, string key, bool encrypt) {
